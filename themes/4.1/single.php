...
<iframe src="http://www.facebook.com/plugins/like.php?app_id=159829247433784&amp;href=<?php echo urlencode(get_permalink($post->ID)); ?>&amp;send=false&amp;layout=standard&amp;width=630&amp;show_faces=true&amp;action=like&amp;colorscheme=light&amp;font&amp;height=80" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:630px; height:80px;" allowTransparency="true"></iframe>    </div>
