    ...
    <head>
        ...
        <?php
            ...
            <div id="Content">
                ...
                <style type="text/css">
				#Intervencao { width:960px; height:90px; margin:15px 0; clear:both; }
                </style>
                <div id="Intervencao">
                	<a href="http://migre.me/6cT4j" target="_blank"><img src="<?php bloginfo('home'); ?>/publicidade/empreendendo-me.jpg" /></a>
                </div>